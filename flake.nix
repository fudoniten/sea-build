{
  ...
  inputs = {
    ...
    fudo-nixos = {
      url =
        "git+ssh://git@github.com/fudoniten/nixos-config.git?ref=26.05-aegis";
      inputs = {
        fudo-entities.follows = "fudo-entities";
        nixpkgs.follows = "nixpkgs";
        fudo-secrets.follows = "fudo-secrets";
      };
    };
  ...
  outputs = { self, nixpkgs, utils, deploy-rs, fudo-nixos, fudo-entities
    , game-site, ... }@inputs:
    with nixpkgs.lib;
    let
        ...
        in {
          ...
          profiles = {
            ...
            aegis = {
              ...
              path =
                deploy-rs.lib.x86_64-linux.activate.custom aegisCiphertext ''
                  set -euo pipefail
            ...
            game-site = {
              ...
              path =
                deploy-rs.lib.x86_64-linux.activate.custom gameSitePackage ''
                  mkdir -p /srv/www
